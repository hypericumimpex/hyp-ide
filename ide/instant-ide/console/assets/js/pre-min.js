! function(a, b) {
    ...
    function(a) {
        a(document).ready(function() {
            ...
            function c() {
                var a = m.path;
                return a && a.length > l.prompt_path_length && (a = "..." + a.slice(a.length - l.prompt_path_length + 3)), "[[b;#35d24a;]" + (m.user || "user") + "]@[[b;#6c9ac4;]" + (m.hostname || l.domain || "web-console") + "] " + (a || "~") + "$ "
            }
            ...
            var l = {
                ...
                n = "undefined" != typeof no_login ? no_login : !1,
                o = !1,
                p = "",
